...
export {CreateUsersTable,CreatePropertiesTable,CreateFlagsTable,getUser,createNewUser,createProperty,getProperty,updateProperty,updatePropertyStatus,getAllPropertiesByTypeWithUserDetails,getAllPropertiesWithUserDetails,deleteProperty}